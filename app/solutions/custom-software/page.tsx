        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
              Scalable <span className="text-orange-600">Software</span> Built for Your Business
            </h1>
            <p className="text-xl text-gray-400 mb-8">
              We move beyond cookie-cutter solutions. We build robust, secure, and scalable custom applications tailored to your specific operational needs.
            </p>
            <Link href="/contact">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Why Choose Custom?</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Off-the-shelf software rarely fits perfectly. Our custom development ensures your software adapts to your workflow, not the other way around.
              </p>
              <ul className="space-y-4">
                {[
                  ...
                  "Scalability without Licensing Fees"
                ].map((item, i) => (
