    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Business Side */}
          <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-black p-8 md:p-12 hover:border-orange-200 transition-colors">
            <div className="absolute top-4 right-4 bg-black text-white p-3 rounded-full">
              <Building2 className="h-6 w-6" />
            </div>
            <h3 className="text-2xl text-white font-bold mb-4">For Business</h3>
            <p className="text-gray-600 mb-8 h-20 text-white">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li
                  key={item}
                  className="flex items-center text-sm font-medium text-black text-white"
                >
          ...
          {/* Student Side */}
          <div className="group relative overflow-hidden rounded-3xl bg-gray-50 text-white p-8 md:p-12 border border-gray-800">
            <div className="absolute top-4 right-4 bg-orange-600 text-black p-3 rounded-full">
              <GraduationCap className="h-6 w-6" />
            </div>
            <h3 className="text-2xl text-black font-bold mb-4">For Learners</h3>
            <p className="text-black mb-8 h-20">
            ...
            <Link href="/academy">
              <Button className="w-full bg-black text-white hover:bg-orange-600 hover:text-white transition-all">
                Browse Courses
              </Button>
            </Link>
          </div>
